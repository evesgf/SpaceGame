...
namespace GPL
{
    public class FireVulcan : FireBase
    {
        public readonly string POOLNAME_BULLET = "FireVulcanBullet";
        public readonly string POOLNAME_MUZZLEFIRE = "FireVulcanMuzzleFire";
        public readonly string POOLNAME_BULLETBOOM = "FireVulcanBulletBoom";
        public readonly string POOLNAME_BULLETAUDIO = "FireVulcanBulletAudio";
